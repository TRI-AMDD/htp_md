...
def trace_particles(trajectory_reference_path, type_id=90, type_id2=94,
    ...
    Returns:
        Save MSD and cluster population matrices
    """
    ...
    with open(trajectory_file_path, 'r') as f:
        ...
        np.save(f'{trajectory_reference_path}/avg_population', avg_population)
        f_target.close()
...
if __name__ == "__main__":
    print(os.getcwd())
    trajectory_ref = '../../test_data/9-0-246295613-0'
    print(os.path.isdir(trajectory_ref))
    trace_particles(trajectory_ref)
